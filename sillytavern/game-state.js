...
export const GameStateSchema = zObject({
  ...
  treasury: zObject({
    items: zArray(TreasuryItemSchema, [
      { id: 'w1', name: '霜华剑', type: '武器', rank: '上品灵器', quantity: 1, color: 'jade', description: '剑身如霜，挥剑时可凝冰气伤人', owner: '', effects: { 杀伐: 45, 防御: 5, 身法: 8 } },
      { id: 'w2', name: '碧落剑', type: '武器', rank: '上品灵器', quantity: 1, color: 'jade', description: '通体碧绿，传闻可引动天地灵气', owner: '', effects: { 杀伐: 42, 防御: 8, 身法: 10 } },
      { id: 'w3', name: '紫电鞭', type: '武器', rank: '中品灵器', quantity: 1, color: 'purple', description: '鞭身缠绕紫电，中者麻痹难动', owner: '', effects: { 杀伐: 35, 防御: 0, 身法: 15 } },
      ...
      { id: 'w6', name: '噬魂刃', type: '武器', rank: '上品灵器', quantity: 1, color: 'pink', description: '魔道凶器，可伤敌神魂', owner: '', effects: { 杀伐: 50, 防御: 0, 身法: 12 } },
      { id: 'a1', name: '玄龟甲', type: '防具', rank: '中品灵器', quantity: 1, color: 'jade', description: '仿上古玄龟背甲所铸，坚不可摧', owner: '', effects: { 杀伐: 0, 防御: 40, 身法: -8 } },
      { id: 'a2', name: '冰蚕衣', type: '防具', rank: '上品灵器', quantity: 1, color: 'purple', description: '万年冰蚕丝织成，水火不侵', owner: '', effects: { 杀伐: 5, 防御: 35, 身法: 10 } },
      { id: 'a3', name: '金丝软甲', type: '防具', rank: '中品灵器', quantity: 1, color: 'gold', description: '金丝编织，轻便柔韧，贴身无形', owner: '', effects: { 杀伐: 0, 防御: 28, 身法: 5 } },
      ...
      { id: 'ac2', name: '储物戒指', type: '饰品', rank: '中品灵器', quantity: 1, color: 'gold', description: '内含独立空间，可储万物', owner: '', effects: { 杀伐: 0, 防御: 5, 身法: 5 } },
  ...
  opportunities: zArray(OpportunitySchema, [
    ...
    { id: 'o6', title: '长老请愿', desc: '有长老请求上调执法堂成员俸禄，称近年宗门收入增加，理应惠及门人', category: 'renhe', cost: 1, completed: false },
    { id: 'o7', title: '成员纷争', desc: '两名成员因一处洞府归属产生激烈矛盾，请求掌门主持公道', category: 'renhe', cost: 1, completed: false },
